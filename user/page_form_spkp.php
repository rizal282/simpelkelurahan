...
if(isset($_POST["btn-save"])){
	...
	$jmlklrg_pindah = $_POST["jmlklrg_pindah"];
			...
			if($size_kk < 3000000){
				if($type_p_foto == "image/jpg" || $type_p_foto == "image/jpeg" || $type_p_foto == "image/png"){
					if($size_kk < 3000000){
						...
						$sql = "insert into surat values('','".$dataUser["nik"]."','SPKP','Surat Pengantar Keterangan Pindah','".$ket."','".$alamat_pindah."','".$new_name_kk."','".$new_name_p_foto."','','Belum Verifikasi','','".$jmlklrg_pindah."','".date("Y-m-d")."','','','','','')";
						...
						echo '<div class="alert alert-info">Surat Anda Telah Dibuat. Silahkan <a href="homeuser.php?pelayanan=spkp&view=v_surat">Lihat</a></div>';
					}else{
...
<form method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group">
    	...
    	<div class="form-group">
    		<label>Jumlah Keluarga Yang Ikut Pindah : </label>
      		<input type="text" name="jmlklrg_pindah" class="form-control">
    	</div>
    	    <div class="form-group">
