...
<div class="panel panel-info">
	...
	<div class="panel-body">
  		<?php
  			include "../proses/gantipassadmin.php";
  		?>
  		<form method="post">
  ...
  <button type="submit" class="btn btn-danger btn-block" name="submit"> <span class="glyphicon glyphicon-edit"></span> Ganti Password</button>
  <br>
  :: Perhatian !! ::.<br>
