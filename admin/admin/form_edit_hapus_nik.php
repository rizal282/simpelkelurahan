...
<form action="" method="post">
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="form-group">
				...
				<input class="form-control" type="date" name="tgl_lahir" value="<?php echo $tanggal_lahir; ?>">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
	...
	<button type="submit" name="btn-edit" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Perbarui</button>
	<button type="submit" name="btn-hapus" class="btn btn-warning"><span class="glyphicon glyphicon-trash"></span> Hapus</button>
